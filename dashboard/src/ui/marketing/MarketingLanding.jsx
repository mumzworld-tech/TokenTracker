            ...
            >
                ...
                <div className="mt-8 w-full max-w-lg mx-auto">
                  <motion.div
                    ...
                    className="group relative flex items-center justify-between w-full bg-[#0a0a0a]/50 backdrop-blur-md border border-oai-gray-800 rounded-2xl p-1.5 pl-5 shadow-2xl shadow-black/50 transition-all duration-300"
                  >
                    {/* Subtle glow effect behind */}
                    <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-oai-brand-500/0 via-oai-brand-500/5 to-oai-brand-500/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
                    ...
                    <button
                      ...
                      className="shrink-0 relative z-10 flex h-9 w-9 items-center justify-center text-oai-gray-200 bg-oai-gray-900 border border-oai-gray-700 rounded-lg hover:bg-oai-gray-800 hover:text-white active:scale-95 transition-all duration-200 shadow-sm"
                    >
                      {installCopied ? (
